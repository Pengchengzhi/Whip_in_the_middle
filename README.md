...
* **11.13 (Yuchuw):** Modified the Load_data.py and Extract.py. (1) Now, we have train and val folder containing ~60 classes' folders; (2) Data Augmentation: Crop, Rotation, Flip, Perspective change, and Blur.
